 ...
 *  2. CSS clip-path wipes from right → left, erasing "m" then "i"
 *  3. Cross-fades to the "a" icon mark at final size
 */
export default function AnimatedAimLogo({
  ...
  // "a" occupies roughly 0–44% of the SVG width (x 172–306 out of 172–484)
  // Wipe clips from right: inset(top right bottom left)
  const clipPath =
    phase === "full"
      ? "inset(0 0% 0 0)"
      : "inset(0 56% 0 0)";
  ...
  return (
    ...
    >
      {/* Full wordmark layer — gets clipped then fades out */}
      <svg
        ...
        style={{
          ...
          transition:
            phase === "erasing"
              ...
              : "clip-path 600ms ease-in-out, opacity 400ms ease-in-out",
        }}
      >
        <path
      ...
      {/* Icon mark layer — fades in once wipe completes */}
      <svg
        ...
        style={{
          ...
          transitionDelay: phase === "icon" ? "200ms" : "0ms",
        }}
      >
        <path
          d="M306 293.5C306 328.57 277.122 357 241.5 357C205.878 357 177 328.57 177 293.5C177 258.43 205.878 230 241.5 230C277.122 230 306 258.43 306 293.5Z"
